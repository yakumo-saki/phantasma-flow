...
func (m *LogListener) Initialize() error {
...
func (m *LogListener) GetName() string {
...
func (m *LogListener) Start(inCh <-chan string, outCh chan<- string) error {
